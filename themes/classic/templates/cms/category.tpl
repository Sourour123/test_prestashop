                            ...
                            {if file_exists($img_cms)}
                                <div id="banner-cms">
                                    ...
                                    <a href="{$cms_page.link}" class="title">
                                        <img src="{$urls.base_url}/img/cms/{$cms_page.id_cms}.jpg" id="cms-img" />
                                    </a>
                                </div>
                            {/if}
                            {$cms_page.content|substr:0:$cut_to nofilter}<br>
                            <span><a href="{$cms_page.link}" class="btn btn-primary">{l s='Lire la suite'}</a></span>
                        </li>
                    {else}
                        {* catégorie normal *}

                        <a href="{$cms_page.link}" class="btn btn-primary">{$cms_page.meta_title}</a>
